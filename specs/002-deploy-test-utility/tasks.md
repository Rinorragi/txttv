...
- [X] T002 [P] Create F# project for test utility in tools/TxtTv.TestUtility/TxtTv.TestUtility.fsproj
...
- [X] T003 [P] Add Argu NuGet package to F# project
...
- [X] T004 [P] Create .gitignore entries for generated files
  - Add `bin/`, `obj/` for .NET builds
  - Add local parameter files
  - Add `*.user` files
  - **Files**: .gitignore (update)

- [X] T005 Create README for examples directory at examples/requests/README.md
...
- [X] T006 [P] Create PowerShell module for Bicep helpers in infrastructure/scripts/lib/BicepHelpers.psm1
...
- [X] T007 [P] Create PowerShell module for Azure authentication in infrastructure/scripts/lib/AzureAuth.psm1
...
- [X] T008 [P] Create PowerShell module for error handling in infrastructure/scripts/lib/ErrorHandling.psm1
...
- [X] T009 [P] Create CLI argument types in tools/TxtTv.TestUtility/CliArguments.fs
...
- [X] T010 [US1] Create main deployment script at infrastructure/scripts/Deploy-Infrastructure.ps1
...
- [X] T011 [US1] Implement parameter validation in Deploy-Infrastructure.ps1
...
- [X] T012 [US1] Implement Azure authentication check in Deploy-Infrastructure.ps1
...
- [X] T013 [US1] Implement Bicep template validation in Deploy-Infrastructure.ps1
...
- [X] T014 [US1] Implement resource group creation/verification in Deploy-Infrastructure.ps1
...
- [X] T015 [US1] Implement Bicep deployment execution in Deploy-Infrastructure.ps1
...
- [X] T016 [US1] Implement deployment progress monitoring in Deploy-Infrastructure.ps1
...
- [X] T017 [US1] Implement deployment result output in Deploy-Infrastructure.ps1
...
- [X] T018 [US1] Implement error handling for deployment failures in Deploy-Infrastructure.ps1
...
- [X] T019 [US1] Create cleanup script at infrastructure/scripts/Remove-Infrastructure.ps1
...
- [X] T020 [US1] Implement resource deletion logic in Remove-Infrastructure.ps1
...
- [X] T021 [US1] Create deployment script tests at tests/deployment/Deploy-Infrastructure.tests.ps1
...
- [X] T022 [P] [US2] Create HTTP client module in tools/TxtTv.TestUtility/HttpClient.fs
...
- [X] T023 [US2] Implement GET request function in HttpClient.fs
...
- [X] T024 [US2] Implement POST request function in HttpClient.fs
...
- [X] T025 [P] [US2] Create response formatter in tools/TxtTv.TestUtility/ResponseFormatter.fs
...
- [X] T026 [US2] Implement Send command handler in tools/TxtTv.TestUtility/Program.fs
...
- [X] T027 [US2] Create HTTP client tests at tests/utility/HttpClient.tests.fs
...
- [X] T028 [P] [US3] Create signature generator module in tools/TxtTv.TestUtility/SignatureGenerator.fs
...
- [X] T029 [US3] Implement signature header addition in HttpClient.fs
...
- [X] T030 [US3] Add signing key parameter to CLI arguments in CliArguments.fs
  - Add --key parameter
  - Make it optional with default value
  - Document in help text
  - **Files**: tools/TxtTv.TestUtility/CliArguments.fs

- [X] T031 [US3] Update Send command to use signing key in Program.fs
  - Read key from CLI argument or environment variable
  - Pass key to HTTP client functions
  - Display signature in verbose output
  - **Files**: tools/TxtTv.TestUtility/Program.fs

- [X] T032 [US3] Create signature generator tests at tests/utility/SignatureGenerator.tests.fs
...
- [X] T033 [P] [US4] Create request loader module in tools/TxtTv.TestUtility/RequestLoader.fs
...
- [X] T034 [P] [US4] Implement List command handler in Program.fs
...
- [X] T035 [US4] Implement Load command handler in Program.fs
...
- [X] T036 [P] [US4] Create legitimate example: GET page 100 at examples/requests/legitimate/get-page-100.json
...
- [X] T037 [P] [US4] Create legitimate example: POST JSON at examples/requests/legitimate/post-json-content.json
...
- [X] T038 [P] [US4] Create legitimate example: POST XML at examples/requests/legitimate/post-xml-content.json
  - Configure POST /api/content
...
- [X] T039 [US4] Create request loader tests at tests/utility/RequestLoader.tests.fs
...
- [X] T040 [P] [US5] Create WAF example: SQL injection basic at examples/requests/waf-tests/sql-injection-basic.json
...
- [X] T041 [P] [US5] Create WAF example: SQL injection union at examples/requests/waf-tests/sql-injection-union.json
...
- [X] T042 [P] [US5] Create WAF example: XSS script tag at examples/requests/waf-tests/xss-script-tag.json
...
- [X] T043 [P] [US5] Create WAF example: XSS event handler at examples/requests/waf-tests/xss-event-handler.json
...
- [X] T044 [US5] Create WAF patterns documentation at examples/requests/waf-tests/README.md
...
- [X] T045 [US5] Create integration test script at tests/integration/waf-example-requests.tests.ps1
...
- [X] T046 Update root README.md with feature documentation
...
- [X] T047 Create comprehensive testing script for full validation
